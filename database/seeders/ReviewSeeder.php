    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                ...
                'img' => "rew/10.webp",
                'score' => 5,
                'description' => "Строил дом на склоне. Думал, будут проблемы, но ребята справились! Сваи поставили идеально, перекосов нет. Техника справилась с сложным рельефом. Рекомендую — профессионалы с большим опытом в ЯНАО.",
                'platform_lnk' => "https://2gis.ru"
            ],
            [
                'name' => "Ольга Козлова",
            ...
            [
                ...
                'img' => "rew/25.webp",
                'score' => 5,
                'description' => "Заказывала в пятый раз! Сначала дом, потом баня, теперь мастерская. Всегда — чёткие сроки, никаких сюрпризов по деньгам. Постоянным клиентам дарят бонусы. Лучшие в ЯНАО, проверено годами!",
                'platform_lnk' => "https://yandex.ru"
            ],
            [
                'name' => "Иван Широков",
